...
export const useRegisterUser = () => {
  return useMutation({
    mutationFn: async (body: any) => registerUserAction(body),
  });
};
...
export const useSendOtp = () => {
  return useMutation({
    mutationFn: async (body: SendOtpApiRequest) => sendOtpAction(body),
  });
};
...
export const useVerifyOtp = () => {
  return useMutation({
    mutationFn: async (body: VerifyOtpApiRequest) => verifyOtpAction(body),
  });
};
